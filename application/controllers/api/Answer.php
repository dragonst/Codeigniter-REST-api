...
class Answer extends \Restserver\Libraries\REST_Controller {
  ...
  public function index_get($id = null)
  {
        ...
        $questions = $this->answer_model->get_foreign($id);

        if (!empty($questions))
        {
            $this->set_response($questions, \Restserver\Libraries\REST_Controller::HTTP_OK); // OK (200) being the HTTP response code
        }
        else
        {
            $this->set_response([
  ...
  public function index_post()
  {
    ...
    $id = $this->answer_model->insert($arr);
